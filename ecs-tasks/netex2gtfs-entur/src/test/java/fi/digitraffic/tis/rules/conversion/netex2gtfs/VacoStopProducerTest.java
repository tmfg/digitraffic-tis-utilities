...
class VacoStopProducerTest {
    ...
    void testDigiroadIdIsCopied() {
        ...
        assertNotNull(stop);
        DigiroadIdStopExtension keyValues = stop.getExtension(DigiroadIdStopExtension.class);
        assertEquals(DIGIROAD_ID, keyValues.getDigiroadId());
    }
    ...
    void testDigiroadIdIsIgnoredWhenKeyValuesAbsent() {
        ...
        assertNotNull(stop);
        assertNull(stop.getExtension(DigiroadIdStopExtension.class));
    }
